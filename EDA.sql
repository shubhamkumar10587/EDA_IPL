...
/*with 
t1 as (select id,season,d_ate,city,team1,team2,winner from matches),
 t2 as (select matchid,batting_team,bowling_team from deliveries)
select distinct 
t1.season,t1.d_ate,t1.city,t1.team1,t1.team2,t2.batting_team,t2.bowling_team,
t1.winner
